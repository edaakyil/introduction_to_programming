...
public class Main
{
  ...
  // b + c > a
	...
	// Soru _ Klavyeden girilen üç kenar uzunluğunun bir ikizkenar üçgen oluşturup oluşturmadığını ekrana yazdıran program.
    ...
    if(a == b)
      if(a != c)
          System.out.print("İkizkenardır.");
      else
        System.out.print("İkizkenar değildir.");
    else 
      if(a == c)
          System.out.print("İkizkenardır.");
      else 
